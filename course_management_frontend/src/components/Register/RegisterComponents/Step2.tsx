        ...
        <div className="w-100 p-5 pt-0">
            <div className="container">
                ...
                <div className="input-group input-group-md m-4">
                    ...
                    <Tooltip hasArrow placement="bottom-end" isOpen={isShowFNTooltip} label="This field can't be empty" bg='red.600'>
                    ...
                    <Tooltip hasArrow placement="bottom-end" isOpen={isShowLNToolTip} label="This field can't be empty" bg='red.600'>
            ...
            <div className="row justify-content-around">
                ...
                <button onClick={handleOnClickNext} className="btn btn-primary h-25 col-5">NEXT&nbsp;<FaLongArrowAltRight size={30} className="d-inline-block" /></button>
            </div>
        </div>
    )
}