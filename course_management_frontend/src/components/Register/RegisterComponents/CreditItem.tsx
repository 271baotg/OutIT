...
export const CreditItem: React.FC<{ handleOnChangeTotal: Function, data: Target }> = (props) => {
    ...
    const handleOnChangeInput = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        console.log('value', props.data.goal);
    }
    ...
    return (
        <div className="card p-1 ps-4">
            <div className="row">
                <div className="col-4 text-bold fw-bolder" style={{ color: getTypeColor(props.data.type) }} >{getTitle(props.data.type)}</div>
                ...
                <div className="col-8 d-flex align-items-center justify-content-end">
                    ...
                    <div>
                        ...
                        <Input onChange={handleOnChangeInput} placeholder="0" value={props.data.goal === 0 ? '' : props.data.goal} className="me-1" fontWeight={'bold'} textAlign={'center'} maxWidth='50px' size='sm' />
